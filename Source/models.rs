...
impl ActiveNotification {
	...
	pub fn group_summary(&self) -> bool { self.group_summary }
...
mod android {
	...
	impl Channel {
		...
		pub fn importance(&self) -> Importance { self.importance }

		pub fn visibility(&self) -> Option<Visibility> { self.visibility }
	}
	...
	impl ChannelBuilder {
		...
		pub fn build(self) -> Channel { self.0 }
	}
}

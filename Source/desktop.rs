...
mod imp {
	...
	impl Notification {
		...
		pub fn new(identifier:impl Into<String>) -> Self {
			Self { identifier:identifier.into(), ..Default::default() }
		}
		...
		/// ## Platform-specific
		///
		/// - **Windows**: Not supported on Windows 7. If your app targets it,
		...
		/// Shows the notification. This API is similar to [`Self::show`], but
